...
const Home = () => {
  ...
  useEffect(() => {
    if (user) {
      const savedSession = sessionStorage.getItem(`currentSession_${user.username}`);
      if (savedSession) {
        try {
  ...
  useEffect(() => {
    if (user && currentSession) {
      sessionStorage.setItem(`currentSession_${user.username}`, JSON.stringify(currentSession));
    } else if (user && !currentSession) {
      sessionStorage.removeItem(`currentSession_${user.username}`);
    }
  }, [currentSession, user]);
